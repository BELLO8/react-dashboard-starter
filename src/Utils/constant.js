export const BASE_URL = "http://192.168.1.14:8081/treizetaxi-api";
...
export const PARTNER_CAR_DELETE =
  "/admin/partenairevehicule/supprimer/vehicule";
...
export const PARTNER_ORDER_LIST =
  "/superadmin/course/recherchercoursespartenaire";
...
export const CAR_LIST = "/superadmin/vehicule/recherchervehicules";
export const CAR_PHOTO = "/admin/vehicule/rechercherphotos";
export const CAR_CHANGE_STATUS = "/superadmin/vehicule/modiferstatus";
export const DRIVER_VEHICULE = "/admin/drivervehicule/rechercherdriverassocier";
...
export const GRAPH_STATS_SALES = "/superadmin/course/recherchergrapheglobal";
export const GRAPH_STATS_COURSES =
  "/superadmin/course/recherchergraphetotalcourse";
export const AVIS = "/superadmin/avis/listavis";
export const ADD_AVIS = "/webfree/avis/enregistrer";
export const DELETE_AVIS = "/superadmin/supprimer";
