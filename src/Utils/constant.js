...
export const DISABLE_USER_ACCOUNT = "";
export const UPDATE_USER_CREDENTIALS ="/superadmin/userback/modifieridentifiant";
...
export const DISABLE_PARTNER_ACCOUNT = "/superadmin/partenaire/desactiverpartenaire";
...
export const ADD_PARTNER ="/superadmin/partenaire/entreprise/enregistrer";
...
export const DRIVER_ORDER_HISTORY = "";
...
export const CATEGORY_CAR_LIST = "";
export const ADD_CATEGORY_CAR = "";
export const EDIT_CATEGORY_CAR = "";
