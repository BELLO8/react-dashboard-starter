              ...
              <div className='h-full'>
                {
                  active === 0 ? (
                    ...
                    <div className='mt-3'>
                      ...
                      {partnerDriver?.drivers?.length === 0 ?
                        (
                          <div className="py-3 flex justify-center">
                          ...
                          >
                            <div className="dropdown dropdown-end absolute right-2 top-2">
                              ...
                              >
                                ...
                                <button
                                  className="bg-white hover:bg-gray-100 text-gray-600 font-semibold h-9 w-full flex items-center justify-start rounded-lg px-3"
                                  onClick={() => document.getElementById(`car_driver${index}`).showModal()}
                                >
                                  Associé un vehicule
                                </button>
                                <button
                            ...
                            <dialog id={`car_driver${index}`} className="modal">
                              <div className="modal-box">
                                ...
                                <button disabled={partnerCars?.vehicules?.length === 0 ? true : false} className="my-3 btn px-8 rounded-lg bg-main hover:bg-main text-white text-sm font-medium">
                                  Assigner
                                </button>
                              </div>
                            </dialog>
