                      ...
                      <div className="mt-6 grid grid-cols-4 gap-4">
                        {users.map((item, index) => (
                          ...
                          >
                            ...
                            {
                              !load ? <Skeleton className="mx-auto mt-5 flex items-center justify-center" animation='wave' variant='circular' width={80} height={80} />
                            ...
                            {
                              !load ? <Skeleton animation='wave' variant='text' width={190} height={40} />
                                : (
