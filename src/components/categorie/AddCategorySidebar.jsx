...
export const AddCategorySidebar = ({ setOpenSide, openSide }) => {
    const {
        register,
        handleSubmit, reset,
        formState: { errors },
        ...
        <>
            <Drawer open={openSide} onClose={() => setOpenSide(false)} anchor='right'>
                <div className='bg-white w-96 px-8 mt-4'>
                    <h1 className='text-lg font-semibold'>Création d'une categorie</h1>
                    <form onSubmit={handleSubmit(submit)}>
                        <div className='my-12'>
                            <div className='my-2'>
                                <label htmlFor="" className='text-sm font-medium'>Marque</label>
                                <input type="text" placeholder="ex : ford" className="px-3 my-2 w-80 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6"
                            ...
                            <div className='my-2'>
                                ...
                                <input type="text" placeholder="ex : mustang" className="px-3 my-2 w-80 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6"
                            ...
                            <div className='my-2'>
                                ...
                                <input type="text" placeholder="ex : Une description " className="px-3 my-2 w-80 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400  sm:text-sm sm:leading-6"
